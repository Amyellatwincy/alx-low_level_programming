 ...
 * @s: is the string
 * Return: return the long of the string
 */
int _lenght(char *s)
{
if (*s == '\0')
 ...
 * @i: is the index
 * @lg: is the lenght of thr string
 * @s: is the string
 * Return: 1 if is polinderome or 0 if not
 */
 ...
 * @s: is the string
 * Return: return 1 if the string is a palidrome or 0 otherwise
 */
